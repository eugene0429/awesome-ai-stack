...
| agent-qa | QA agent for natural-language web/mobile regressions, with persistent test memory, self-healing flows, evidence-backed triage, a local MCP server, and bundled coding-agent skills. | [github.com/vostride/agent-qa](https://github.com/vostride/agent-qa) | `Skill` `Free` |
